...
export default {
  ...
  about_us_intro: `<p><span >JSConf China（JavaScript 中国开发者大会）是一个为期两天的以技术开发者为中心的非营利国际性技术大会，主要关注JavaScript和Node.JS 方面的技术。我们将邀请众多国内外JavaScript社区著名的开发者来分享他们的知识及对JavaScript的独到见解。这里是过去几届活动的链接</span><span > (</span><a href="http://2012.jsconf.cn" target="new" >2012</a><span >, </span><a href="http://2013.jsconf.cn" target="new" >2013</a><span >, </span><a href="http://2014.jsconf.cn" target="new" >2014</a><span >, </span><a href="http://2015.jsconf.cn" target="new" >2015</a><span >). </span><span >你也可以在线观看深JS 2015的视频：</span><span > </span><a href="https://www.youtube.com/channel/UCvFAekDfG_dL2Kcbq-vrPXQ" target="new" >YouTube</a><span > </span><span >和</span><span > </span><a href="http://www.tudou.com/home/wiredcraft" target="new" >Tudou</a><span >. </span><span >今年JS中国开发者大会将在南京于</span><strong ><span>2016年9月3日 - 9月4日举行</span>.</strong</p>`,
  ...
  call_for_sponsors_mini_intro: '有兴趣支持中国JavaScript社区？成为我们2016宁JS的赞助商吧',
  gold_sponsor: '金牌赞助商',
  sliver_sponsor: '银牌赞助商',
  bronze_sponsor: '铜牌赞助商',
  what_else_sponsor: '您还可以在以下方面为我们提供帮助：',
  speaker_sponsor: '讲师赞助',
  speaker_sponsor_intro: '为您公司的讲师提供交通以及餐饮费用的报销。',
  food_sponsor: '食物以及酒水赞助',
  food_sponsor_intro: '派对与茶歇的品牌曝光有限，希望可以是非技术相关。',
  media_sponsor: '媒体伙伴',
  media_sponsor_intro: '非资金类赞助，相互作为合作伙伴，尽可能为大会提供媒体推广与宣传。',
  ...
  'ShenJS 2015@Shenzhen': '深JS 2015@深圳',

  take_a_look: '了解更多',
  take_a_look_intro: `To see presentations from last year's ShenJS, please look at our past conference sites at jsconf.cn or check out the videos on YouTube or Tudou.`,
