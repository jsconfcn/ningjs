...
export default {
  ...
  nanjing: '南京',
  stay_tuned: '敬请期待',
  stay_tuned_intro: '第一时间得到相关资讯',
  notify_me: '获取最新讯息',
  notify_me_footer: '通知我',
  follow_wechat: '在微信上关注我们',
  interest_sponsor_2016: '成为2016宁JS的赞助商？',
  sponsor_now: '点击了解更多！',
  proposals_accept_time:'从现在起我们开始接收讲师申请及推荐，截止至2016年6月1日北京时间晚12点。',
  apply: '在线申请',
  ...
  about_us_intro: `<p><span>JSConf China（JavaScript 中国开发者大会）是一个为期两天的以技术开发者为中心的非营利国际性技术大会，主要关注JavaScript和Node.JS 方面的技术。期间我们将邀请众多国内外JavaScript社区著名的开发者来分享他们的知识及对JavaScript的独到见解。这里是过去几届活动的链接：</span><span>（</span><a href="http://2012.jsconfchina.com" target="new" >2012</a><span>，</span><a href="http://2013.jsconfchina.com" target="new" >2013</a><span>，</span><a href="http://2014.jsconfchina.com" target="new" >2014</a><span>，</span><a href="http://2015.jsconfchina.com" target="new" >2015</a><span>）。</span>去年深圳JS大会的视频可以在 <a href='https://www.youtube.com/channel/UCvFAekDfG_dL2Kcbq-vrPXQ' target='new'>YouTube</a> 和 <a href='http://www.tudou.com/home/wiredcraft' target='new'>Tudou</a>上看到。<span>今年JS中国开发者大会将在南京于</span><strong ><span>2016年9月3日 － 9月4日举行</span>.</strong</p>`,

  call_for_speakers_intro: `<p>2016年的JavaScript中国开发者大会（NingJS 2016）将于<strong>9月3日-4日</strong>在南京举行。现已开放讲师及赞助商的申请通道，截止时间为<strong>北京时间2016年6月1日24点</strong>。欢迎所有JavaScirpt 开发者及爱好者的踊跃参与！</p>
  <p>JavaScript中国开发者大会（JSConf China）是一个以JS开发者为中心的活动。我们希望为来自中国本土及国际JS 社区的开发者们提供一个分享、讨论最前沿的JS技术和工具的平台。你可以用英文或中文演讲。</p>
  <h4>申请成为讲师或者推荐优秀讲师给我们</h4>
  <p>如果你有新颖的观点要分享，请告诉我们。如果你知道其他的优秀讲师，请推荐给我们。如果你有特别想了解的话题，告诉我们，我们会尽力帮你找到匹配的讲师。总之，填写表格吧！</p>
  <p>如果你想了解往届的活动，这里是过去四年在分别在上海、北京、杭州、深圳举行的JS中国开发者大会（<a href='http://2012.jsconfchina.com' target='new'>2012</a>，<a href='http://2013.jsconfchina.com' target='new'>2013</a>，<a href='http://2014.jsconfchina.com' target='new'>2014</a>，<a href='http://2015.jsconfchina.com' target='new'>2015</a>）。去年深圳JS大会的视频可以在 <a href='https://www.youtube.com/channel/UCvFAekDfG_dL2Kcbq-vrPXQ' target='new'>YouTube</a> 和 <a href='http://www.tudou.com/home/wiredcraft' target='new'>Tudou</a>上看到。</p>
  <h4>我们欢迎任何形式的演讲，也非常愿意提供帮助</h4>
  <p>如果这是你的第一次演讲，并且想在提交申请前得到一些反馈，请联系活动组织者 <a href="mailto:support@jsconfchina.com">support@jsconfchina.com </a>，我们会及时回复。<strong>注意，通过邮件提交的演讲将不会被接受，请通过这个表格提交。</strong></p>`,
  call_for_speakers_mini_intro: '我们正在邀请JavaScript社区为即将到来的2016宁JS提交话题（2016年9月3日-9月4日，南京）',
  apply_now: '现在申请',
  the_perks: '讲师特权',
  benifit_for_apply: '如果你被选为NingJS的演讲嘉宾，你将会得到以下特权：',
  accomodation: '机票与住宿',
  dinner: '讲师晚餐',
  ticket: '大会门票',
  ...
  <h4>赞助方案</h4>
  <p>2016宁JS提供三个等级的赞助方案: 金，银，铜。您的支持对于大会来说非常重要，能够保证大会主办人员更好地组织与筹办这次活动。我们将详细列出不同方案的特权以及费用，如果您对于赞助文档有任何的需求与疑问，请告诉我们！<a href='mailto:support@jsconfchina.com'>support@jsconfchina.com</a></p>`,
  ...
  speaker_sponsor_intro: '提供贵公司讲师的交通及住宿。',
  food_sponsor: '派对及茶歇期间赞助',
  food_sponsor_intro: '可获得派对及茶歇期间品牌曝光，可以是非技术相关品牌。',
  media_sponsor: '媒体伙伴',
  ...
  'HangJS @ Hangzhou': '杭JS @ 杭州',
  'ShenJS @ Shenzhen': '深JS @ 深圳',
  'NingJS @ Nanjing': '宁JS @ 南京',
  'JSConf 2015 @ Shenzhen': 'JSConf 2015 @ 深圳',

  take_a_look: '了解更多',
  take_a_look_intro: `<span>想了解更多去年的深JS开发者大会？请移步官网（</span><span><a href='http://2015.jsconfchina.com/' target='new'>http://2015.jsconfchina.com</a></span><span>）、</span><a href="https://www.youtube.com/channel/UCvFAekDfG_dL2Kcbq-vrPXQ" target="new" >YouTube</a><span>或者</span><a href="http://www.tudou.com/home/wiredcraft" target="new" >Tudou</a>。
`,
